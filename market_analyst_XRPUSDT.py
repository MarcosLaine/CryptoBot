...
# Get symbol information for XRPUSDT
symbol_info = client.get_symbol_info("XRPUSDT")
...
while True:
    ...
    create_info_box("XRPUSDT", min_qty, max_qty, step_size, current_price)
